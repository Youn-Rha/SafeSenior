...
class Plot3D():
    def __init__(self):
        ...
        self.previousClouds = []
        self.numPersistentFrames = int(NUM_PERSISTENT_FRAME)
    ...
    def addBoundBox(self, name, minX=0, maxX=0, minY=0, maxY=0, minZ=0, maxZ=0):
        ...
        try:
            # INFO : Here to plot BLUE boundary Box
            ...
            print("ERROR : Failed to plot boundaryBox (Plot3D.addBoundBox())")
            pass
    ...
    def parseSensorPosition(self, args):
